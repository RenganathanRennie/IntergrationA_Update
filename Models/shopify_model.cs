...
{
public class shopify_model
    {
        // shopify_modelmain myDeserializedClass = JsonConvert.DeserializeObject<shopify_modelmain>(myJsonResponse);
    ...
    public class BillingAddress
    {
        ...
        public object admin_graphql_api_id { get; set; }
    }
    ...
    public class LineItem
    {
        ...
        public object tip_payment_method { get; set; }
        ...
        public object fulfillment_line_item_id { get; set; }
        public long id { get; set; }
        public string admin_graphql_api_id { get; set; }
    }
